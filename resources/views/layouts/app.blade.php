                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <div>
                            ...
                            <li><a class="nav-link" href="{{ url('/products') }}"><i class="far fa-square"></i> <span>All</span></a></li>
                            <li><a class="nav-link" href="{{ url('/units') }}"><i class="fas fa-columns"></i> <span>Unit & Specs</span></a></li>
                            <li><a class="nav-link" href="{{ url('/product_category_item') }}"><i class="fas fa-th"></i> <span>Category</span></a></li>

{{--                            <li class="dropdown">--}}
{{--                                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Unit & Specs</span></a>--}}
{{--                                <ul class="dropdown-menu">--}}
{{--                                    <li><a class="nav-link" href="layout-default.html">All</a></li>--}}
...
{{--                            </li>--}}
                        ...
                        <div>
                            ...
                            <li><a class="nav-link" href="{{ url('/deliveries/create') }}"><i class="fas fa-plus"></i><span>New</span></a></li>
                            <li><a class="nav-link" href="{{ url('/deliveries') }}"><i class="far fa-newspaper"></i> <span>All</span></a></li>
                            <li><a class="nav-link" href="{{ url('/deliveries/handleDelivery') }}"><i class="fas fa-hourglass-start"></i> <span>Handle</span></a></li>
                            <li><a class="nav-link" href="{{ url('/purchasers') }}"><i class="fas fa-hourglass-start"></i> <span>Purchasers</span></a></li>
        ...
        <footer class="main-footer">
            <div class="footer-left">
                Copyright &copy; <div class="bullet"></div> <a target="_blank">AsianTown</a>
            </div>
